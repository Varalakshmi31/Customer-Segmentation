...
Original file is located at
    https://colab.research.google.com/drive/1TM2fXwd2L1le0D7f6EHQTAOKyoj6iRaa
"""

!pip install streamlit

!streamlit run template.visualization
...
pipeline = load_model('classifier.pkl')
st.set_page_config(layout="wide")

pipeline = load_model('classifier.pkl')
#pipeline = load_model('kmeans_classifier.pkl')

df = load_excel('marketing_campaign1.xlsx')
